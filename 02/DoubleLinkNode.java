...
public class DoubleLinkNode<E> {
     ...
     * @param p reference to a DoubleLinkNode that should precede the new
     *          DoubleLinkNode
     * @param n reference to a DoubleLinkNode that should follow the new
     *          DoubleLinkNode
     */
    ...
    /**
     * Returns the DoubleLinkNode that precedes this one (or null if no such
     * DoubleLinkNode).
     * 
    ...
    /**
     * Returns the DoubleLinkNode that follows this one (or null if no such
     * DoubleLinkNode).
     * 
     ...
     */
    public void setPrev(DoubleLinkNode<E> p) {
        prev = p;
    }
     ...
     */
    public void setNext(DoubleLinkNode<E> n) {
        next = n;
    }
}